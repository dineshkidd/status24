      ...
      <Table className="">
        <TableHeader>
          <TableRow className="border-b border-border hover:bg-transparent font-mono">
            ...
            <TableHead className="h-12 px-4 w-[280px]">Status</TableHead>
            <TableHead className="h-12 px-4 w-[100px] text-right">Actions</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {sortedServices.map((service) => (
            ...
            >
              <TableCell className="font-medium p-4 w-[200px]">{service.name}</TableCell>
              ...
              <TableCell className="p-4 w-[280px]">
                <div className="flex items-center gap-2">
                  <Select
              ...
              <TableCell className="p-4 w-[100px] text-right">
                <AlertDialog>
